  ...
  return (
    <div className=" flex bg-slate-50 h-14 justify-around items-center border-t">
      <div
        ...
        className={`${
          location.pathname === "/welcome" ? "text-primary" : ""
        } cursor-pointer`}
      >
        <svg
      ...
      <div
        onClick={() => navigate("/welcome/post")}
        className={`${
          location.pathname === "/welcome/post" ? "text-primary" : ""
        } cursor-pointer`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div
        ...
        className={`${
          location.pathname === "/welcome/account" ? "text-primary" : ""
        } cursor-pointer`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
